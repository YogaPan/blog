...
- [[JS] 透過 JavaScript 處理檔案上傳（AJAX Upload byte / JSON / formData File） ~ PJCHENder<br>那些沒告訴你的小細節](https://pjchender.blogspot.com/2019/01/js-javascript-input-file-upload-file.html)
