...
- [Cookie vs Local Storage vs Session Storage](#cookie-vs-local-storage-vs-session-storage)
- [安全性](#安全性)
- [使用情境](#使用情境)
...
[window.localStorage](https://developer.mozilla.org/en-US/docs/Web/API/Window/localStorage) 能夠讓妳存取當前 Domain 下的 [Storage](https://developer.mozilla.org/en-US/docs/Web/API/Storage) 物件，並透過以下四隻 API 進行操作:
