...
- [目錄](#目錄)
- [Expires, Cache-Control, max-age](#expires-cache-control-max-age)
  - [Case 1](#case-1)
  - [Case 2](#case-2)
  - [Case 3](#case-3)
  - [重點整理](#重點整理)
...
- [no-store, no-cache](#no-store-no-cache)
  - [Example](#example)
  - [重點整理](#重點整理-1)
- [Long Term Cache](#long-term-cache)
  - [Example](#example-1)
- [總結](#總結)
- [待解決問題](#待解決問題)
- [參考資料](#參考資料)
...
A: 每次請求都問 Server 檔案是否有更動，如果有更動  則回應新的資源，否則回應 `status code: 304 (Not Modified)`
