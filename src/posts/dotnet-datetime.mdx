...
```C#
new DateTime(2020, 1, 1, 0, 0, 0);  // Kind: Unspecified
new DateTime(2020, 1, 1, 0, 0, 0, DateTimeKind.Utc);  // Kind: Utc
new DateTime(2020, 1, 1, 0, 0, 0, DateTimeKind.Local);  // Kind: Local
```
...
⚠️ C# 的 DateTime 沒辦法和 Js 的 Date 或 Moment 一樣，可以直接修改時間。
