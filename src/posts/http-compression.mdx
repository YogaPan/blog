...
- [Proactive Negotiation (內容協商)](#proactive-negotiation-內容協商)
- [使用 Express Middleware 壓縮](#使用-express-middleware-壓縮)
- [使用 Dotnet Core Middleware 壓縮](#使用-dotnet-core-middleware-壓縮)
- [Reference](#reference)
