...
- [pushState](#pushstate)
  - [Case 1: Relative Path](#case-1-relative-path)
  - [Case 2: Absolute Path](#case-2-absolute-path)
  - [Case 3: Null Path](#case-3-null-path)
  - [Case 4: Push state](#case-4-push-state)
- [replaceState](#replacestate)
- [onstatepop event](#onstatepop-event)
- [參考資料](#參考資料)
- [延伸閱讀](#延伸閱讀)
